...
import { register as registerService } from '@/src/lib/api';
...
export const RegisterModal = ({ isDashboard, onClose }: Props) => {
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        const response = await registerService(email, password, isDashboard ? 'admin' : 'user');
    ...
    return (
        <Modal onClose={onClose} addBackground={!isDashboard}>
            <Title title="Register" description="Register your account." />
            <form onSubmit={onSubmit}>
                ...
                <div className="mt-4">
                    <div className={twMerge('flex', isDashboard ? 'justify-end' : 'justify-between')}>
                        ...
                        <Button scheme="primary">Register</Button>
                    </div>
